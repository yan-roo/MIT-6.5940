...
Implementation notes and code for the **four lab assignments** of MIT 6.5940 — *TinyML and Efficient Deep Learning Computing*.
...
| ----- | -------------------------- | ------------------ | -------------------------------------------------------- |
| **1** | Pruning                    | 2024‑09‑17 → 09‑26 | fine‑grained / channel pruning, FLOPs & latency analysis |
